					...
					<ul class="nav pull-right">
						...
						<li class="dropdown hidden-phone">						
							...
							<ul class="dropdown-menu notifications">
                            	<li>
                                    <a href="chartpage.php?loc=ltoreh">
								...
								<li>
                                    <a href="chartpage.php?loc=lubusatu">
										<span class="icon orange"><i class="icon-map-marker"></i></span>
										<span class="message">Lubu Satu</span>
								                            	...
								                            	<li>
                                    <a href="chartpage.php?loc=lubudua">
										<span class="icon orange"><i class="icon-map-marker"></i></span>
								...
								<li>
                                    <a href="chartpage.php?loc=talusatu">
										<span class="icon orange"><i class="icon-map-marker"></i></span>
								...
								<li>
                                    <a href="chartpage.php?loc=taludua">
										<span class="icon orange"><i class="icon-map-marker"></i></span>
