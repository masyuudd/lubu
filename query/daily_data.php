...
for ($x=0; $x<count($hil); $x++)
{
	...
	$query_latest = "SELECT * FROM $hil[$x] WHERE `SamplingDate` = '$skr'";
	...
	*/		
	...
	$my_file2 = "F:\\Dropbox\\data\\daytemp.txt";
	// simpan ke file temp
	
	$myfile2 = fopen($my_file2, "r") or die("Unable to open file!");
